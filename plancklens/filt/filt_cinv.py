...
class cinv_tp:
    ...
    def hashdict(self):
        return {'lmax': self.lmax,
                ...
                'cltt': utils.clhash(getattr(self.cl, 'cltt', [0.])),
                'clte': utils.clhash(getattr(self.cl, 'clte', [0.])),
                'cltb': utils.clhash(getattr(self.cl, 'cltb', [0.])),
                'clee': utils.clhash(getattr(self.cl, 'clee', [0.])),
                'cleb': utils.clhash(getattr(self.cl, 'cleb', [0.])),
                'clbb': utils.clhash(getattr(self.cl, 'clbb', [0.])),
                'transf': utils.clhash(self.transf),
                'ninv': self._ninv_hash(),
